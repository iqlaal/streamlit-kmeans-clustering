...
# Page Configuration
st.set_page_config(
    page_title="KMeans Clustering Customer Segmentation",
    page_icon="🏪",
    layout="wide",
...
with st.sidebar:
    st.title('🏪 KMeans Clustering Customer Segmentation')
    st.markdown('Gunakan sidebar untuk memilih parameter KMeans')

    # Sidebar untuk memilih jumlah cluster
    n_clusters = st.slider("Pilih jumlah cluster", min_value=2, max_value=10, value=5)
...
# Fitur yang dipilih untuk clustering (Annual Income dan Spending Score)
